...
- date: 2026-09-08T00:53:29-04:00
- host: benchmark host, kernel 7.1.9-arch1-2
- fixture: /path/to/fixtures/media
- fixture payload: 2000 visible entries, filesystem btrfs
- TUI terminal: kitty 0.48.2-1
- flea launch line: FLEA_BIN=/path/to/flea/target/release/flea FLEA_UI=/path/to/flea/ui setsid nohup /path/to/flea/target/release/flea --gui /path/to/fixtures/media
- load average at start: 0.47 1.36 1.36
- waited 60 seconds for the box to go idle before starting
- TUI preview target: /path/to/fixtures/media/photo_0.jpg
...
- age at run time: 7 hours

## Entrants

```
flea       gui  source f8751aa (clean), release binary built 2026-09-08T00:20:24-04:00, 1085048 bytes
...
set previewer /path/to/bench-config/lf/previewer.sh
set cleaner /path/to/bench-config/lf/cleaner.sh
```
...
- ended: 2026-09-08T01:08:37-04:00
- load average at end: 1.50 1.99 1.84
...
- pcmanfm produced mp4 400, png 106, webm 100; refused nothing; never attempted heic 200, jpg 600, mkv 100, png 94, txt 200, webp 200
...
- the ranked rows differ in thumbnail work by 16x, from 36 to 606, so their settle times are not ranked against each other

## Public copy

Hostname and absolute checkout/fixture paths are anonymized. Measurements, versions and run times are unchanged.
