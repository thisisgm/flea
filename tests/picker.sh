...
# Usage: ./tests/picker.sh [pick|click|save|savename|typed|typed_dir|typed_file|typed_url|typed_share|cancel|withdrawn|died|fault|pills|taildrop|dragout]; typed_share, taildrop and dragout are opt-in.
