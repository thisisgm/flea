...
var SHARED_KEYS = [
    ...
    {"mods":"ctrlalt","key":"Plus","keys":"alt-+","action":"thumbSizeUp","context":"listing","frontend":"all","preset":"all","code":"Key_Plus","text":"","ctrl":true,"shift":false,"alt":true,"super":false,"keycode":Qt.Key_Plus,"mask":(Qt.ControlModifier | Qt.AltModifier)},
    {"mods":"ctrlalt","key":"Equal","keys":"alt-+","action":"thumbSizeUp","context":"listing","frontend":"all","preset":"all","code":"Key_Equal","text":"","ctrl":true,"shift":false,"alt":true,"super":false,"keycode":Qt.Key_Equal,"mask":(Qt.ControlModifier | Qt.AltModifier)},
    {"mods":"ctrlalt","key":"Minus","keys":"alt--","action":"thumbSizeDown","context":"listing","frontend":"all","preset":"all","code":"Key_Minus","text":"","ctrl":true,"shift":false,"alt":true,"super":false,"keycode":Qt.Key_Minus,"mask":(Qt.ControlModifier | Qt.AltModifier)},
    {"mods":"ctrlalt","key":"Underscore","keys":"alt--","action":"thumbSizeDown","context":"listing","frontend":"all","preset":"all","code":"Key_Underscore","text":"","ctrl":true,"shift":false,"alt":true,"super":false,"keycode":Qt.Key_Underscore,"mask":(Qt.ControlModifier | Qt.AltModifier)},
    {"mods":"ctrlalt","key":"0","keys":"alt-0","action":"thumbSizeReset","context":"listing","frontend":"all","preset":"all","code":"Key_0","text":"","ctrl":true,"shift":false,"alt":true,"super":false,"keycode":Qt.Key_0,"mask":(Qt.ControlModifier | Qt.AltModifier)},
    {"mods":"ctrlaltshift","key":"Plus","keys":"alt-+","action":"thumbSizeUp","context":"listing","frontend":"all","preset":"all","code":"Key_Plus","text":"","ctrl":true,"shift":true,"alt":true,"super":false,"keycode":Qt.Key_Plus,"mask":(Qt.ControlModifier | Qt.AltModifier | Qt.ShiftModifier)},
    {"mods":"ctrlaltshift","key":"Equal","keys":"alt-+","action":"thumbSizeUp","context":"listing","frontend":"all","preset":"all","code":"Key_Equal","text":"","ctrl":true,"shift":true,"alt":true,"super":false,"keycode":Qt.Key_Equal,"mask":(Qt.ControlModifier | Qt.AltModifier | Qt.ShiftModifier)},
    {"mods":"ctrlaltshift","key":"Minus","keys":"alt--","action":"thumbSizeDown","context":"listing","frontend":"all","preset":"all","code":"Key_Minus","text":"","ctrl":true,"shift":true,"alt":true,"super":false,"keycode":Qt.Key_Minus,"mask":(Qt.ControlModifier | Qt.AltModifier | Qt.ShiftModifier)},
    {"mods":"ctrlaltshift","key":"Underscore","keys":"alt--","action":"thumbSizeDown","context":"listing","frontend":"all","preset":"all","code":"Key_Underscore","text":"","ctrl":true,"shift":true,"alt":true,"super":false,"keycode":Qt.Key_Underscore,"mask":(Qt.ControlModifier | Qt.AltModifier | Qt.ShiftModifier)},
